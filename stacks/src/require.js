    ...
    function newContext(contextName) {
                ...
                each(this.depMaps, bind(this, function (depMap, i) {
                    ...
                    if (typeof depMap === 'string') {
                        ...
                        if (this.errback) {
                            ...
                            // No direct errback on this modules, but something
        ...
        function intakeDefines() {
            ...
            while (defQueue.length) {
                args = defQueue.shift();
                if (args[0] === null) {
                    return onError(makeError('mismatch', 'Mismatched anonymous define() modules: ' +
                        args[args.length - 1]));
                } else {
        ...
        context = {
            ...
            makeRequire: function (relMap, options) {
                ...
                mixin(localRequire, {
                    ...
                    /**
                     * Converts a modules name + .extensions into an URL path.
                    ...
                    toUrl: function (moduleNamePlusExt) {
                        ...
                        //Have a file extensions alias, and it is not the
            ...
            nameToUrl: function (moduleName, ext, skipExt) {
                ...
                if (req.jsExtRegExp.test(moduleName)) {
                    ...
                    //Add extensions if it is included. This is a bit wonky, only non-.js things pass
                    //an extensions, this method probably needs to be reworked.
                    url = moduleName + (ext || '');
                } else {
